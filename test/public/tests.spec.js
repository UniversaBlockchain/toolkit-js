...
describe('Network', function() {
  describe("Connection", function() {
    ...
    it('should connect to network with provided topology', async function() {
      ...
      const topology = Topology.load(packedTopology);
  ...
  describe("Topology", function() {
    it('should pack topology', function() {
      ...
      packedTopology.updated.should.equal(repacked.updated);
      packedTopology.list.length.should.equal(repacked.list.length);
    });
  });
